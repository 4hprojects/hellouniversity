document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadQuiz(quizId) {
        ...
        .then(data => {
            if (data.success) {
                quizData = shuffleAndAdjustQuestions(data.quiz.questions); // Updated shuffling logic
        ...
        function submitQuiz() {
            saveResponse(); // Ensure the last response is saved
...
// Adjusted to ensure correctAnswer is updated after shuffling options
function shuffleAndAdjustQuestions(questions) {
    return questions.map(question => {
        // Shuffle the options and track the new index of the correct answer
        ...
        return {
            ...
            correctAnswer: newCorrectAnswerIndex, // Update to the new correct index
        };
    });
}
