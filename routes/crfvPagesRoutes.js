...
function createCrfvPagesRoutes({
  ...
  router.get(['/crfv', '/crfv/', '/crfv/index'], (req, res) => {
    ...
    const pageLocals = {
      ...
      description:
        'Welcome to the CRFV Event System main menu. Access attendance, registration, event creation, and reports.',
      canonicalUrl: 'https://hellouniversity.online/crfv/index',
      stylesheets: ['/dist/output.css', '/crfv/css/index.css'],
      extraHead: `
  ...
  router.get('/crfv/attendance', (req, res) => {
    ...
    const pageLocals = {
      ...
      description:
        'RFID attendance monitoring for CRFV events. Secure, mobile-friendly, and easy to use.',
  ...
  router.get('/crfv/reports', isAdminOrManager, (req, res) => {
    ...
    const pageLocals = {
      ...
      description:
        'View, export, and analyze attendance, accommodation, events, and audit logs for CRFV events.',
  ...
  router.get('/crfv/account-settings', isAuthenticated, (req, res) => {
    ...
    const pageLocals = {
      ...
      description:
        'Manage your CRFV user profile, credentials, and session settings.',
